...
eng-vllm-qwen	vLLM Neural LLM Engine	vLLM OpenAI-Compatible	llm	Qwen/Qwen2.5-7B-Instruct-AWQ	http://77.104.167.149:45717/v1	sk-ibrasoft-gpu-voice	all	110	$0.00 / Self-Hosted GPU	t	t	Self-hosted private GPU cluster running vLLM OpenAI-compatible REST server with Qwen 2.5 7B Instruct AWQ.	0	0	110	0.00	active	2026-09-04 16:15:10.126604+00
eng-kokoro-tts	Kokoro Ultra-Fast Neural TTS	Kokoro-82M ONNX	tts	kokoro-82m	http://77.104.167.149:45042	sk-ibrasoft-gpu-voice	all	45	$0.005 / 1K chars	t	t	Ultra-low ~45ms latency ONNX TTS engine with 82M parameters. 24 kHz, 16-bit Mono PCM WAV.	0	0	110	0.00	active	2026-09-04 17:03:43.28246+00
eng-whisper-stt	Faster-Whisper CUDA Streaming Transcriber	Faster-Whisper CUDA	stt	distil-large-v3	http://77.104.167.149:45064	sk-ibrasoft-gpu-voice	all	180	$0.003 / min	t	t	Real-time distil-large-v3 model on NVIDIA CUDA (float16) with entity extraction and websocket streaming.	0	0	110	0.00	active	2026-09-04 17:03:43.28246+00
eng-vad-silero	Silero VAD v5 Neural Chunk Monitor	Silero VAD GPU Microservice	stt	silero-vad-v5	http://77.104.167.149:45810	sk-ibrasoft-gpu-voice	all	5	$0.00 / Self-Hosted GPU	t	f	Sub-5ms caller interruption / barge-in neural chunk monitor with 16 kHz sample rate, 512 samples per frame (32ms window).	0	0	5	0.00	active	2026-09-04 18:28:43.572952+00
\.
