...
func (h *SuperAdminHandler) ensureSchemaAndSeed() {
	...
	_, _ = h.db.Exec(ctx, `
		...
		(
			...
			'Qwen/Qwen2.5-7B-Instruct-AWQ', 'http://77.54.200.11:15460/v1', 'IbraSoft-GPUZvrMmfSn3ePVE9spRQ2hi751fGSXq5sFpovfUl7XOggbMRRHee8zRk4SWV7YBSUF',
		...
		(
			...
			'kokoro-v1.0', 'http://77.54.200.11:15188', 'IbraSoft-GPUZvrMmfSn3ePVE9spRQ2hi751fGSXq5sFpovfUl7XOggbMRRHee8zRk4SWV7YBSUF',
		...
		(
			...
			'distil-large-v3', 'http://77.54.200.11:15490', 'IbraSoft-GPUZvrMmfSn3ePVE9spRQ2hi751fGSXq5sFpovfUl7XOggbMRRHee8zRk4SWV7YBSUF',
	...
	if aiEngineCount == 0 {
		...
		('eng-vllm-qwen', 'vLLM Neural LLM Engine', 'OpenAI-Compatible vLLM', 'llm', 'Qwen/Qwen2.5-7B-Instruct-AWQ', 'http://77.54.200.11:15460/v1', 'IbraSoft-GPUZvrMmfSn3ePVE9spRQ2hi751fGSXq5sFpovfUl7XOggbMRRHee8zRk4SWV7YBSUF', 'all', 45, '$0.00 / Self-Hosted GPU', true, true, 'Production vLLM OpenAI-Compatible high-throughput inference engine running on NVIDIA RTX 4060 Ti (16GB VRAM).', 'active', NOW()),
		('eng-tts-kokoro-gpu', 'Kokoro-82M ONNX TTS', 'Kokoro ONNX Neural', 'tts', 'kokoro-v1.0', 'http://77.54.200.11:15188', 'IbraSoft-GPUZvrMmfSn3ePVE9spRQ2hi751fGSXq5sFpovfUl7XOggbMRRHee8zRk4SWV7YBSUF', 'all', 45, '$0.00 / Self-Hosted GPU', true, true, 'Ultra-fast neural text-to-speech with 54 multi-language voices on NVIDIA RTX 4060 Ti.', 'active', NOW()),
		('eng-stt-whisper-gpu', 'Faster-Whisper CUDA STT', 'Faster-Whisper CUDA', 'stt', 'distil-large-v3', 'http://77.54.200.11:15490', 'IbraSoft-GPUZvrMmfSn3ePVE9spRQ2hi751fGSXq5sFpovfUl7XOggbMRRHee8zRk4SWV7YBSUF', 'all', 180, '$0.00 / Self-Hosted GPU', true, true, 'High-accuracy streaming speech-to-text powered by CUDA float16 distil-large-v3 on NVIDIA RTX 4060 Ti.', 'active', NOW()),
		('eng-vad-silero-gpu', 'Silero VAD v5 Neural Chunk Monitor', 'Silero Neural VAD', 'stt', 'silero-vad-v5', 'http://77.54.200.11:15089', 'IbraSoft-GPUZvrMmfSn3ePVE9spRQ2hi751fGSXq5sFpovfUl7XOggbMRRHee8zRk4SWV7YBSUF', 'all', 5, '$0.00 / Self-Hosted GPU', true, true, 'Sub-5ms caller interruption and barge-in voice activity detector on NVIDIA RTX 4060 Ti.', 'active', NOW())
